...
public class TestTraceWithCustomOutputPath {
  final static Path outputPath = Paths.get(System.getProperty("java.io.tmpdir")).resolve("playwright-custom-output");

  public static class TestOptions implements OptionsFactory {
    @Override
    public Options getOptions() {
      return new Options().setTrace(Options.Trace.ON).setOutputDir(outputPath);
    }
  }
